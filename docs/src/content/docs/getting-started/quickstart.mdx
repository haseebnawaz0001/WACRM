---
title: Quickstart
description: Get WA CRM up and running in minutes
---

import { Steps, Aside, Tabs, TabItem } from '@astrojs/starlight/components';

Get WA CRM up and running in minutes using Docker or manual installation.
...
4. Add these credentials in WA CRM's **Settings** → **Accounts**
