...
WA CRM keeps a record-level audit trail of every create / update / delete on the resources that matter for compliance and debugging. Each entry is scoped to an organization and answers the four standard questions: **who** did **what** to **which record**, and **when**.
