      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Contact Fields', slug: 'api-reference/contact-fields' },
            { label: 'Conversations & Inbox', slug: 'api-reference/conversations' },
            { label: 'Tasks', slug: 'api-reference/tasks' },
            { label: 'Segments', slug: 'api-reference/segments' },
            { label: 'Deals & Pipelines', slug: 'api-reference/deals' },
            { label: 'Automations', slug: 'api-reference/automations' },
            ...
            { label: 'CRM Reports', slug: 'api-reference/reports' },
