...
export const buttonVariants = cva(
  "btn-press inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-sm text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        // One flat colour, straight off the theme token. The gradient and its
        // coloured halo were the loudest thing on most screens: every primary
        // action glowed, so none of them carried more weight than another, and
        // a glow with no offset is decoration rather than depth.
