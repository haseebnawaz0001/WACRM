...
func TestApp_ListCampaigns_Success(t *testing.T) {
	...
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("list-campaigns")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_ListCampaigns_FilterByStatus(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("list-filter")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_CreateCampaign_Success(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("create-campaign")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_CreateCampaign_WithScheduledAt(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("create-scheduled")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_CreateCampaign_InvalidTemplateID(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("invalid-template")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_CreateCampaign_TemplateNotFound(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("template-not-found")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_CreateCampaign_AccountNotFound(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("account-not-found")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_CreateCampaign_InvalidRequestBody(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("invalid-body")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_GetCampaign_Success(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("get-campaign")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_GetCampaign_NotFound(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("get-not-found")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_GetCampaign_InvalidID(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("get-invalid-id")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_UpdateCampaign_Success(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("update-campaign")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_UpdateCampaign_NotDraft(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("update-not-draft")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_UpdateCampaign_NotFound(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("update-not-found")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_DeleteCampaign_Success(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("delete-campaign")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_DeleteCampaign_WithRecipients(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("delete-with-recipients")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_DeleteCampaign_RunningCampaign(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("delete-running")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_DeleteCampaign_NotFound(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("delete-not-found")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_StartCampaign_Success(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("start-campaign")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_StartCampaign_NoPendingRecipients(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("start-no-recipients")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_StartCampaign_InvalidStatus(t *testing.T) {
	...
	for _, status := range statuses {
		t.Run("status_"+string(status), func(t *testing.T) {
			...
			app := newTestApp(t, withQueue(mockQueue))
			org := testutil.CreateTestOrganization(t, app.DB)
			user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("start-invalid-"+string(status))), testutil.WithPassword("password"), testutil.WithAdminRole(t, app.DB, org.ID))
...
func TestApp_StartCampaign_CanResumePaused(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("resume-paused")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_PauseCampaign_Success(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("pause-campaign")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_PauseCampaign_NotRunning(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("pause-not-running")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_CancelCampaign_Success(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("cancel-campaign")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_CancelCampaign_AlreadyFinished(t *testing.T) {
	...
	for _, status := range finishedStatuses {
		t.Run("status_"+string(status), func(t *testing.T) {
			...
			app := newTestApp(t, withQueue(mockQueue))
			org := testutil.CreateTestOrganization(t, app.DB)
			user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("cancel-finished-"+string(status))), testutil.WithPassword("password"), testutil.WithAdminRole(t, app.DB, org.ID))
...
func TestApp_ImportRecipients_Success(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("import-recipients")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_ImportRecipients_WithTemplateParams(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("import-with-params")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_ImportRecipients_WithHeaderParams(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("import-header-params")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_ImportRecipients_NotDraft(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("import-not-draft")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_GetCampaignRecipients_Success(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("get-recipients")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_GetCampaignRecipients_CampaignNotFound(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("get-recipients-not-found")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_RetryFailed_Success(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("retry-failed")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_RetryFailed_NoFailedRecipients(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("retry-no-failed")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_RetryFailed_InvalidStatus(t *testing.T) {
	...
	app := newTestApp(t, withQueue(mockQueue))
	org := testutil.CreateTestOrganization(t, app.DB)
	user := testutil.CreateTestUser(t, app.DB, org.ID, testutil.WithEmail(testutil.UniqueEmail("retry-invalid-status")), testutil.WithPassword("password"), testutil.WithRoleID(&testutil.CreateAdminRole(t, app.DB, org.ID).ID))
...
func TestApp_Campaign_CrossOrgIsolation(t *testing.T) {
	...
	user1 := testutil.CreateTestUser(t, app.DB, org1.ID, testutil.WithEmail(testutil.UniqueEmail("cross-org-1")), testutil.WithPassword("password"), testutil.WithAdminRole(t, app.DB, org1.ID))
	user2 := testutil.CreateTestUser(t, app.DB, org2.ID, testutil.WithEmail(testutil.UniqueEmail("cross-org-2")), testutil.WithPassword("password"), testutil.WithAdminRole(t, app.DB, org2.ID))
