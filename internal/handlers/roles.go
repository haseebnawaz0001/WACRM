...
func (a *App) ListRoles(r *fastglue.Request) error {
	orgID, userID, err := a.requireAnyPermission(r, perm(models.ResourceRoles, models.ActionRead), perm(models.ResourceUsers, models.ActionRead))
	if err != nil {
		return nil
	}
...
func (a *App) ListPermissions(r *fastglue.Request) error {
	if _, _, err := a.requireAnyPermission(r, perm(models.ResourceRoles, models.ActionRead), perm(models.ResourceUsers, models.ActionRead)); err != nil {
		return nil
	}
